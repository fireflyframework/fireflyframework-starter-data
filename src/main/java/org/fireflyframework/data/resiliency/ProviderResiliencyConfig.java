 ...
 *
 * <p>Allows each data provider to have independent resilience settings
 * (circuit breaker, retry, rate limiter, bulkhead, timeout) that override
 * the global defaults managed by {@link ResiliencyDecoratorService}.</p>
 */
@Data
